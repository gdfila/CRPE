...
<div id="container_prepa" class="top_content">
    ...
    <section class="accroche">
        <div class="container">
            <div class="row">
                <h1 class="x-large">Pourquoi venir se préparer aux Cours Galien ?</h1>
                <p class="medium">Découvrez les raisons principales : Une expérience de plus de 20 ans dans la préparation de aux concours. Une méthode qui fait ses preuves chaque année autour des marches de la réussite. Une équipe d’enseignants spécialiste des matières enseignées. Un encadrement personnalisé. Une organisation parfaitement adaptée à vos horaires. Et un espace de vie propice aux études.</p>
            </div><!-- /row -->
        </div><!-- /container -->
    </section><!-- /accroche -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-3 savoir_faire_container">
                    ...
                    <h3 class="small"><strong>L'expérience</strong></h3>
                ...
                <div class="col-sm-3 savoir_faire_container">
                    ...
                    <h3 class="small"><strong>La méthode</strong></h3>
                ...
                <div class="col-sm-3 savoir_faire_container">
                    ...
                    <h3 class="small"><strong>L'encadrement</strong></h3>
                ...
                <div class="col-sm-3 savoir_faire_container">
                    ...
                    <h3 class="small"><strong>Le cadre</strong></h3>
    ...
    <section class="pedagogie">
        <div class="container outil_pedagogique">
            <h1 class="large">Nos outils pédagogique</h1>
            <div class="row">
                <div class="col-sm-4 outil_pedagogique_container">
                    <h3 class="small"><strong><a class="btn btn-primary" href="#">Studius</a></strong></h3>
                ...
                <div class="col-sm-4 outil_pedagogique_container">
                    <h3 class="small"><strong><a class="btn btn-primary" href="#">Nos Supports</a></strong></h3>
                ...
                <div class="col-sm-4 outil_pedagogique_container">
                    <h3 class="small h3_text_normal"><strong><a class="btn btn-primary" href="#">Le sMOOC</a></strong></h3>
